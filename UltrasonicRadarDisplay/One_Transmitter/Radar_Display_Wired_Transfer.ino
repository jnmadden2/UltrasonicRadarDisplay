...
//
//Serial myPort;  // Declare a Serial object to manage communication
//
//String angle="";
//String distance="";
//String data="";
...
//  // Read the incoming data and process it when a period (.) is encountered
//  String data = myPort.readStringUntil('.');  // Read the data until the '.' character
//  if (data != null) {
//    data = trim(data);  // Clean up any extra spaces
//    println("Received data: " + data);  // Print received data to the console
//    processData(data);  // Process the data (e.g., extract angle and distance)
//  }
//}
//
//void draw() {
