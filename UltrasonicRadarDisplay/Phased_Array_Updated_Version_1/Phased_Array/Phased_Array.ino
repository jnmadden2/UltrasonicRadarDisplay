...
//---------- to post to MQTT server
//client.publish("esp32/sensor1", message); //topic name (to which this ESP32 publishes its data)
    //esp32/sensor1 is the channel on the PI (DO NOT CHANGE)
    //the other argument is the message
