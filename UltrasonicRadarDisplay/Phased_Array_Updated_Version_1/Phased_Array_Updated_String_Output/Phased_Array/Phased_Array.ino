...
//-----------------------------------------
long lastMsg;
const char *MQTTssid = "sdmay25-36";
const char *MQTTpassword = "password";
//this is the rpi IP address 
const char* RPIaddress = "10.26.43.117"; //RPI ip
WiFiClient wifiClient;
// 1883 is the listener port for the Broker
PubSubClient client(RPIaddress, 1883, wifiClient); 
...
void setup() {
  ...
  //------------- MQTT setup
  connect_MQTT();
  client.setServer(RPIaddress,1883);//1883 is the default port for MQTT server
...
//------------------------------------------------------------------------  
  ...
  WiFi.begin(ssid); //starts connection to IASTATE
